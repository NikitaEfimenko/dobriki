...
export const FeedApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    feedArticlesDelete: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("feedArticlesDelete", "id", id);
      const localVarPath = `/feed/articles/{id}/`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    feedArticlesFans: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("feedArticlesFans", "id", id);
      const localVarPath = `/feed/articles/{id}/fans/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    feedArticlesLike: async (
      ...
      // verify required parameter 'data' is not null or undefined
      assertParamExists("feedArticlesLike", "data", data);
      const localVarPath = `/feed/articles/{id}/like/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    feedArticlesPartialUpdate: async (
      id: number,
      data: Article,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
    ...
    feedArticlesUnlike: async (
      ...
      // verify required parameter 'data' is not null or undefined
      assertParamExists("feedArticlesUnlike", "data", data);
      const localVarPath = `/feed/articles/{id}/unlike/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    feedCategoryDelete: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("feedCategoryDelete", "id", id);
      const localVarPath = `/feed/category/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    feedCategoryPartialUpdate: async (
      id: number,
      data: ArticleCategory,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesCreate(data, options);
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesDelete(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesFans(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesLike(id, data, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async feedArticlesList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<FeedArticlesList200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesList(
          ordering,
          search,
          category,
          page,
     ...
     * @throws {RequiredError}
     */
    async feedArticlesPartialUpdate(
      id: number,
      data: Article,
      options?: AxiosRequestConfig
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesPartialUpdate(
          id,
          data,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesRead(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesUnlike(id, data, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedArticlesUpdate(id, data, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async feedCategoryCreate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ArticleCategory>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryCreate(data, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryDelete(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async feedCategoryList(
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<ArticleCategoryPreview>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async feedCategoryPartialUpdate(
      id: number,
      data: ArticleCategory,
      options?: AxiosRequestConfig
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryPartialUpdate(
          id,
          data,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryRead(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.feedCategoryUpdate(id, data, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const FeedApiFactory = function (
  ...
  return {
     ...
     */
    feedArticlesCreate(
      requestParameters: FeedApiFeedArticlesCreateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesCreate(requestParameters.data, options)
     ...
     */
    feedArticlesDelete(
      requestParameters: FeedApiFeedArticlesDeleteRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
        .feedArticlesDelete(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Получает всех пользователей, которые лайкнули `obj`.
     ...
     */
    feedArticlesFans(
      requestParameters: FeedApiFeedArticlesFansRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesFans(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Лайкает `obj`.
     ...
     */
    feedArticlesLike(
      requestParameters: FeedApiFeedArticlesLikeRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesLike(requestParameters.id, requestParameters.data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    feedArticlesList(
      requestParameters: FeedApiFeedArticlesListRequest = {},
      options?: AxiosRequestConfig
    ): AxiosPromise<FeedArticlesList200Response> {
      return localVarFp
        .feedArticlesList(
     ...
     * @throws {RequiredError}
     */
    feedArticlesPartialUpdate(
      requestParameters: FeedApiFeedArticlesPartialUpdateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesPartialUpdate(
     ...
     */
    feedArticlesRead(
      requestParameters: FeedApiFeedArticlesReadRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesRead(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Удаляет лайк с `obj`.
     ...
     */
    feedArticlesUnlike(
      requestParameters: FeedApiFeedArticlesUnlikeRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesUnlike(
     ...
     */
    feedArticlesUpdate(
      requestParameters: FeedApiFeedArticlesUpdateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Article> {
      return localVarFp
        .feedArticlesUpdate(
     ...
     */
    feedCategoryCreate(
      requestParameters: FeedApiFeedCategoryCreateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ArticleCategory> {
      return localVarFp
        .feedCategoryCreate(requestParameters.data, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    feedCategoryDelete(
      requestParameters: FeedApiFeedCategoryDeleteRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
        .feedCategoryDelete(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    feedCategoryPartialUpdate(
      requestParameters: FeedApiFeedCategoryPartialUpdateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ArticleCategory> {
      return localVarFp
        .feedCategoryPartialUpdate(
     ...
     */
    feedCategoryRead(
      requestParameters: FeedApiFeedCategoryReadRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ArticleCategory> {
      return localVarFp
        .feedCategoryRead(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    feedCategoryUpdate(
      requestParameters: FeedApiFeedCategoryUpdateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ArticleCategory> {
      return localVarFp
        .feedCategoryUpdate(
...
=======
   ...
   * @memberof FeedApi
   */
  public feedArticlesPartialUpdate(
    requestParameters: FeedApiFeedArticlesPartialUpdateRequest,
    options?: AxiosRequestConfig
  ) {
    return FeedApiFp(this.configuration)
   ...
   * @memberof FeedApi
   */
  public feedArticlesUnlike(
    requestParameters: FeedApiFeedArticlesUnlikeRequest,
    options?: AxiosRequestConfig
  ) {
    return FeedApiFp(this.configuration)
      .feedArticlesUnlike(requestParameters.id, requestParameters.data, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof FeedApi
   */
  public feedArticlesUpdate(
    requestParameters: FeedApiFeedArticlesUpdateRequest,
    options?: AxiosRequestConfig
  ) {
    return FeedApiFp(this.configuration)
      .feedArticlesUpdate(requestParameters.id, requestParameters.data, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof FeedApi
   */
  public feedCategoryPartialUpdate(
    requestParameters: FeedApiFeedCategoryPartialUpdateRequest,
    options?: AxiosRequestConfig
  ) {
    return FeedApiFp(this.configuration)
  ...
  public feedCategoryUpdate(
    ...
    return FeedApiFp(this.configuration)
      .feedCategoryUpdate(requestParameters.id, requestParameters.data, options)
      .then((request) => request(this.axios, this.basePath));
  }
>>>>>>> 6a008b2c68f9a7af680017f9bb094745a32f159b
}
